 ...
 *
 *
 * Date:           Generated on         Wed May 13 17:31:23 2009
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/7630/rdb/b0/bchp_nand.h $
 * 
 * Hydra_Software_Devel/1   5/14/09 1:30a tdo
 ...
 ***************************************************************************/
#define BCHP_NAND_REVISION                       0x01402800 /* NAND Revision */
#define BCHP_NAND_CMD_START                      0x01402804 /* Nand Flash Command Start */
#define BCHP_NAND_CMD_EXT_ADDRESS                0x01402808 /* Nand Flash Command Extended Address */
#define BCHP_NAND_CMD_ADDRESS                    0x0140280c /* Nand Flash Command Address */
#define BCHP_NAND_CMD_END_ADDRESS                0x01402810 /* Nand Flash Command End Address */
#define BCHP_NAND_CS_NAND_SELECT                 0x01402814 /* Nand Flash EBI CS Select */
#define BCHP_NAND_CS_NAND_XOR                    0x01402818 /* Nand Flash EBI CS Address XOR with 1FC0 Control */
#define BCHP_NAND_SPARE_AREA_READ_OFS_0          0x01402820 /* Nand Flash Spare Area Read Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_4          0x01402824 /* Nand Flash Spare Area Read Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_8          0x01402828 /* Nand Flash Spare Area Read Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_C          0x0140282c /* Nand Flash Spare Area Read Bytes 12-15 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_0         0x01402830 /* Nand Flash Spare Area Write Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_4         0x01402834 /* Nand Flash Spare Area Write Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_8         0x01402838 /* Nand Flash Spare Area Write Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_C         0x0140283c /* Nand Flash Spare Area Write Bytes 12-15 */
#define BCHP_NAND_ACC_CONTROL                    0x01402840 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG                         0x01402848 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1                       0x01402850 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2                       0x01402854 /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SEMAPHORE                      0x01402858 /* Semaphore */
#define BCHP_NAND_FLASH_DEVICE_ID                0x01402860 /* Nand Flash Device ID */
#define BCHP_NAND_FLASH_DEVICE_ID_EXT            0x01402864 /* Nand Flash Extended Device ID */
#define BCHP_NAND_BLOCK_LOCK_STATUS              0x01402868 /* Nand Flash Block Lock Status */
#define BCHP_NAND_INTFC_STATUS                   0x0140286c /* Nand Flash Interface Status */
#define BCHP_NAND_ECC_CORR_EXT_ADDR              0x01402870 /* ECC Correctable Error Extended Address */
#define BCHP_NAND_ECC_CORR_ADDR                  0x01402874 /* ECC Correctable Error Address */
#define BCHP_NAND_ECC_UNC_EXT_ADDR               0x01402878 /* ECC Uncorrectable Error Extended Address */
#define BCHP_NAND_ECC_UNC_ADDR                   0x0140287c /* ECC Uncorrectable Error Address */
#define BCHP_NAND_READ_ERROR_COUNT               0x01402880 /* Read Error Count */
#define BCHP_NAND_CORR_STAT_THRESHOLD            0x01402884 /* Correctable Error Reporting Threshold */
#define BCHP_NAND_FLASH_READ_EXT_ADDR            0x01402890 /* Flash Read Data Extended Address */
#define BCHP_NAND_FLASH_READ_ADDR                0x01402894 /* Flash Read Data Address */
#define BCHP_NAND_PROGRAM_PAGE_EXT_ADDR          0x01402898 /* Page Program Extended Address */
#define BCHP_NAND_PROGRAM_PAGE_ADDR              0x0140289c /* Page Program Address */
#define BCHP_NAND_COPY_BACK_EXT_ADDR             0x014028a0 /* Copy Back Extended Address */
#define BCHP_NAND_COPY_BACK_ADDR                 0x014028a4 /* Copy Back Address */
#define BCHP_NAND_BLOCK_ERASE_EXT_ADDR           0x014028a8 /* Block Erase Extended Address */
#define BCHP_NAND_BLOCK_ERASE_ADDR               0x014028ac /* Block Erase Address */
#define BCHP_NAND_INV_READ_EXT_ADDR              0x014028b0 /* Flash Invalid Data Extended Address */
#define BCHP_NAND_INV_READ_ADDR                  0x014028b4 /* Flash Invalid Data Address */
#define BCHP_NAND_BLK_WR_PROTECT                 0x014028c0 /* Block Write Protect Enable and Size for EBI_CS0b */
#define BCHP_NAND_ACC_CONTROL_CS1                0x014028d0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS1                     0x014028d4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS1                   0x014028d8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS1                   0x014028dc /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS2                0x014028e0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS2                     0x014028e4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS2                   0x014028e8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS2                   0x014028ec /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_ACC_CONTROL_CS3                0x014028f0 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG_CS3                     0x014028f4 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1_CS3                   0x014028f8 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2_CS3                   0x014028fc /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_10         0x01402930 /* Nand Flash Spare Area Read Bytes 16-19 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_14         0x01402934 /* Nand Flash Spare Area Read Bytes 20-23 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_18         0x01402938 /* Nand Flash Spare Area Read Bytes 24-27 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_1C         0x0140293c /* Nand Flash Spare Area Read Bytes 28-31 */
 ...
 ***************************************************************************/
#define BCHP_NAND_FLASH_CACHEi_ARRAY_BASE                          0x01402a00
