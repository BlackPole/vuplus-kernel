...
#define BCHP_VCXO_CTL_CONFIG_FSM_RING_OSC_ENABLE 0x00043064 /* Enable Ring Oscillators (not used) */
#define BCHP_VCXO_CTL_CONFIG_FSM_REF_CLOCK_COUNTER 0x00043068 /* Reference Clock Counter (not used) */
#define BCHP_VCXO_CTL_CONFIG_FSM_VIEW_CLOCK_COUNTER 0x0004306c /* View Clock Counter (not used) */
#define BCHP_VCXO_CTL_CONFIG_FSM_RESET_COUNTER   0x00043070 /* Reset counters (not used) */
#define BCHP_VCXO_CTL_CONFIG_FSM_STOP_COUNTER    0x00043074 /* Stop counters (not used) */
#define BCHP_VCXO_CTL_CONFIG_FSM_IN_RANGE        0x00043078 /* View clock counter is in range (not used) */
#define BCHP_VCXO_CTL_CONFIG_FSM_MISC            0x00043038 /* Misc features (not used) */
#define BCHP_VCXO_CTL_CONFIG_FSM_DIFFOSC_CTRL    0x0004303c /* DIFFOSC Control bits (not used) */
