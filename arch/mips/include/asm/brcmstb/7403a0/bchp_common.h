 ...
 * 
 * Hydra_Software_Devel/7   2/23/08 4:42p pntruong
 * PR30087: Synced up with central rdb, and added l2 bint id for dpcr.
 * 
...
#define BCHP_REGISTER_SIZE                                 0x00b00004 /* VICH is last */
